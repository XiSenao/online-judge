export const m = {
  ...
  List_UnSolved_Problems: '未解决问题的列表',
  UserHomeIntro_solved: '这个家伙太懒了，还没有做题呢...',
  UserHomeIntro_unsolved: '这个家伙还没有未解决的题目呢...',
   // CertificationSetting.vue
  Quick_Select: '快速选取学校&学院&专业',
  School: '学校',
  Faculty: '学院',
  Major: '专业',
  Class: '班级',
  ...
  Identity_Under_Review: '稍安勿躁 正在审核', 
  Identity_Verification_Passed: '审核成功',
  Identity_Verification_Failure: '审核失败',
  First_Submission_Time: '首次申请时间',
