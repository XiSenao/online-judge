...
export default {
  ...
  computed: {
    ...
    showChart: {
      ...
      set (value) {
        this.$store.commit(`contest/${types.CHANGE_CONTEST_ITEM_VISIBLE}`, {chart: value})
      }
    },
    showMenu: {
      get () {
      ...
      set (value) {
        this.$store.commit(`contest/${types.CHANGE_CONTEST_ITEM_VISIBLE}`, {menu: value})
        this.$nextTick(() => {
          if (this.showChart) {
    ...
    showRealName: {
      ...
      set (value) {
        this.$store.commit(`contest/${types.CHANGE_CONTEST_ITEM_VISIBLE}`, {realName: value})
        if (value) {
