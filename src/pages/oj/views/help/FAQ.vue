    ...
    <div class="content markdown-body">
      <ul>
        ...
        <li>{{ $t('m.What_is_the_meaning_of_submission_execution_time') }}
          <p>{{ $t('m.What_is_the_meaning_of_submission_execution_time_answer') }}</p>
        </li>
        ...
        <li>{{ $t('m.How_to_report_bugs') }}
          <p>{{ $t('m.How_to_report_bugs_answer_part_1') }} <a href="https://github.com/FinalAshen/Online-Judge">Github</a>
